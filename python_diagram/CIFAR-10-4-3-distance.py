...
df1 = pd.read_csv('./csv/cifar10/4_3/cifar10_4_3_64_source.csv')
df2 = pd.read_csv('./csv/cifar10/4_3/cifar10_4_3_64_fineTune.csv')
df3 = pd.read_csv('./csv/cifar10/4_3/cifar10_4_3_64_prune_0.1.csv')
df4 = pd.read_csv('./csv/cifar10/4_3/cifar10_4_3_64_prune_0.3.csv')
df5 = pd.read_csv('./csv/cifar10/4_3/cifar10_4_3_64_prune_0.5.csv')
...
y1 = list(df1['distance(4->3)'])
y2 = list(df2['distance(4->3)'])
y3 = list(df3['distance(4->3)'])
y4 = list(df4['distance(4->3)'])
y5 = list(df5['distance(4->3)'])
...
plt.xlabel('近边界数据数量')
plt.ylabel('距离分类边界距离')
plt.savefig('../yzw/image/CIFAR-10-4-3-distance.png', dpi=300)
plt.show()
