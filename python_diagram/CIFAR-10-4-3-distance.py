...
df2 = pd.read_csv('./csv/cifar10/4_3/cifar10_4_3_64_prune_0.1.csv')
df3 = pd.read_csv('./csv/cifar10/4_3/cifar10_4_3_64_prune_0.3.csv')
df4 = pd.read_csv('./csv/cifar10/4_3/cifar10_4_3_64_prune_0.5.csv')
df5 = pd.read_csv('./csv/cifar10/4_3/cifar10_4_3_64_fineTune.csv')
...
plt.xlabel('近边界数据数量')
plt.ylabel('距离分类边界距离')
plt.savefig('./pic/CIFAR-10-4-3-distance.png', dpi=300)
plt.show()
