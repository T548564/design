...
df1 = pd.read_csv('./csv/cifar10/5_6/cifar10_5_6_64_source.csv')
df2 = pd.read_csv('./csv/cifar10/5_6/cifar10_5_6_64_fineTune.csv')
df3 = pd.read_csv('./csv/cifar10/5_6/cifar10_5_6_64_prune_0.1.csv')
df4 = pd.read_csv('./csv/cifar10/5_6/cifar10_5_6_64_prune_0.3.csv')
df5 = pd.read_csv('./csv/cifar10/5_6/cifar10_5_6_64_prune_0.5.csv')
...
y1 = list(df1['distance(5->6)'])
y2 = list(df2['distance(5->6)'])
y3 = list(df3['distance(5->6)'])
y4 = list(df4['distance(5->6)'])
y5 = list(df5['distance(5->6)'])
...
plt.xlabel('近边界数据数量')
plt.ylabel('距离分类边界距离')
plt.savefig('../yzw/image/CIFAR-10-5-6-distance.png', dpi=300)
plt.show()