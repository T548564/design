...
df1 = pd.read_csv('./csv/Intel_images/5_0/Intel_images_5_0_64_source.csv')
df2 = pd.read_csv('./csv/Intel_images/5_0/Intel_images_5_0_64_fineTune.csv')
df3 = pd.read_csv('./csv/Intel_images/5_0/Intel_images_5_0_64_prune_0.1.csv')
df4 = pd.read_csv('./csv/Intel_images/5_0/Intel_images_5_0_64_prune_0.3.csv')
df5 = pd.read_csv('./csv/Intel_images/5_0/Intel_images_5_0_64_prune_0.5.csv')
...
y1 = list(df1['distance(5->0)'])
y2 = list(df2['distance(5->0)'])
y3 = list(df3['distance(5->0)'])
y4 = list(df4['distance(5->0)'])
y5 = list(df5['distance(5->0)'])
...
# plt.savefig('../yzw/image/Intel_image-5-0-distance.png', dpi = 600)
plt.show()