...
df1 = pd.read_csv('./csv/Intel_images/3_5/Intel_images_3_5_64_source.csv')
df2 = pd.read_csv('./csv/Intel_images/3_5/Intel_images_3_5_64_fineTune.csv')
df3 = pd.read_csv('./csv/Intel_images/3_5/Intel_images_3_5_64_prune_0.1.csv')
df4 = pd.read_csv('./csv/Intel_images/3_5/Intel_images_3_5_64_prune_0.3.csv')
df5 = pd.read_csv('./csv/Intel_images/3_5/Intel_images_3_5_64_prune_0.5.csv')
...
y1 = list(df1['distance(3->5)'])
y2 = list(df2['distance(3->5)'])
y3 = list(df3['distance(3->5)'])
y4 = list(df4['distance(3->5)'])
y5 = list(df5['distance(3->5)'])
...
# plt.savefig('../yzw/image/Intel_image-3-5-distance.png', dpi =600)
plt.show()