...
df2 = pd.read_csv('./csv/Intel_images/3_5/Intel_images_3_5_64_prune_0.1.csv')
df3 = pd.read_csv('./csv/Intel_images/3_5/Intel_images_3_5_64_prune_0.3.csv')
df4 = pd.read_csv('./csv/Intel_images/3_5/Intel_images_3_5_64_prune_0.5.csv')
df5 = pd.read_csv('./csv/Intel_images/3_5/Intel_images_3_5_64_fineTune.csv')
...
plt.xlabel('近边界数据数量')
plt.ylabel('距离分类边界距离')
plt.savefig('./pic/Intel_image-3-5-distance.png', dpi = 300)
plt.show()