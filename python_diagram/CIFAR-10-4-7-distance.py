...
y1 = list(df1['distance(4->7)'])
y2 = list(df2['distance(4->7)'])
y3 = list(df3['distance(4->7)'])
y4 = list(df4['distance(4->7)'])
y5 = list(df5['distance(4->7)'])
...
# plt.savefig('../yzw/image/CIFAR-10-4-7-distance.png', dpi = 600)
plt.show()