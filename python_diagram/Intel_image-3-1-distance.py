...
df1 = pd.read_csv('./csv/Intel_images/3_1/Intel_images_3_1_64_source.csv')
df2 = pd.read_csv('./csv/Intel_images/3_1/Intel_images_3_1_64_fineTune.csv')
df3 = pd.read_csv('./csv/Intel_images/3_1/Intel_images_3_1_64_prune_0.1.csv')
df4 = pd.read_csv('./csv/Intel_images/3_1/Intel_images_3_1_64_prune_0.3.csv')
df5 = pd.read_csv('./csv/Intel_images/3_1/Intel_images_3_1_64_prune_0.5.csv')
...
y1 = list(df1['distance(3->1)'])
y2 = list(df2['distance(3->1)'])
y3 = list(df3['distance(3->1)'])
y4 = list(df4['distance(3->1)'])
y5 = list(df5['distance(3->1)'])
...
# plt.savefig('../yzw/image/Intel_image-3-1-distance.png', dpi = 600)
plt.show()